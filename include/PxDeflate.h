...
#ifndef PODX_DEFLATE_H
#define PODX_DEFLATE_H
...
compress_result deflate_init(compress_stream& cs, File* file, PxCompression compression, PxChecksum checksum, uint32_t check32);
...
// returns COMPRESS_SUCCESS on success
// and COMPRESS_ERROR on failure
compress_result inflate_init(compress_stream& cs, File* file, PxChecksum checksum, uint32_t check32);
